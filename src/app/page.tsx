  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-[#0f2540] to-slate-900 py-20 md:py-28 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <form action="/browse" method="GET" className="mb-4">
            <div className="flex gap-2 bg-white/10 border border-white/20 rounded-xl p-1.5 max-w-lg mx-auto">
              <select
                name="category"
                defaultValue=""
                className="bg-white/10 border-0 text-white placeholder-white/60 text-sm rounded-lg px-3 py-2 outline-none appearance-none cursor-pointer"
              >
                <option value="" className="text-gray-900">All Types</option>
                <option value="Apartment / Condominium" className="text-gray-900">Condo / Apt</option>
            ...
            <p className="text-white/40 text-xs mt-2">
              Or{' '}
              <Link href="/browse?type=sale" className="text-white/60 hover:text-white underline underline-offset-2">browse subsale</Link>
              {' · '}
              <Link href="/browse?type=rent" className="text-white/60 hover:text-white underline underline-offset-2">browse rentals</Link>
            </p>
          </form>
      ...
      <section className="bg-white py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <p className="text-[#1e3a5f] font-semibold text-sm uppercase tracking-wider mb-2">Simple Process</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                desc: 'Our AI cross-references 15,000+ listings, rental yield data, auction schedules, and market trends to find your best matches.',
              },
              {
                step: '03',
      ...
      <section className="bg-slate-50 py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <p className="text-[#1e3a5f] font-semibold text-sm uppercase tracking-wider mb-2">Explore</p>
            ...
            {[
              {
                ...
                desc: 'Browse thousands of verified residential listings across Malaysia, direct from private owners.',
                count: `${saleListings.length.toLocaleString('en-MY')} listings`,
                href: '/subsale',
                gradient: 'from-[#1e3a5f] to-[#0f2540]',
                btnClass: 'bg-[#0f2540] hover:bg-[#0a1e38]',
              ...
              },
              {
                ...
                count: 'Coming soon',
                href: '/rent-to-own',
                gradient: 'from-[#1e3a5f] to-[#0a1e38]',
                btnClass: 'bg-[#1e3a5f] hover:bg-[#0f2540]',
                icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z',
              },
            ].map((cat) => (
              <div key={cat.title} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 group">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[#1e3a5f] text-xs font-semibold mb-4 uppercase tracking-wide">{cat.count}</p>
      ...
      <section className="py-20 bg-[#edf2f8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between mb-8">
            <div>
              <p className="text-[#1e3a5f] font-semibold text-sm uppercase tracking-wider mb-1">Eksklusif</p>
              <h2 className="text-2xl font-bold text-gray-900">Senarai Baharu Minggu Ini</h2>
              <p className="text-gray-500 text-sm mt-1">Listing eksklusif eHartanah — terus dari ejen kami</p>
            </div>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between mb-8">
          <div>
            <p className="text-[#1e3a5f] font-semibold text-sm uppercase tracking-wider mb-1">Subsale Properties</p>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between mb-8">
            <div>
              <p className="text-[#1e3a5f] font-semibold text-sm uppercase tracking-wider mb-1">For Rent</p>
              <h2 className="text-2xl font-bold text-gray-900">Latest Rental Listings</h2>
            </div>
      ...
      <section className="bg-slate-900 py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <p className="text-[#d4a017] font-semibold text-sm uppercase tracking-wider mb-2">Technology</p>
      ...
      <section className="bg-white py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <p className="text-[#1e3a5f] font-semibold text-sm uppercase tracking-wider mb-2">Benefits</p>
