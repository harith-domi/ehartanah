...
export default function HomePage() {
  return (
    <>
      {/* HERO */}
      <section className="relative bg-gradient-to-br from-slate-900 via-emerald-950 to-slate-900 py-20 md:py-28 overflow-hidden">
        {/* Background shapes */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-10 left-10 w-72 h-72 bg-emerald-600/10 rounded-full blur-3xl" />
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          {/* AI badge */}
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-600/20 to-teal-600/20 border border-emerald-500/30 text-emerald-300 text-xs font-semibold px-4 py-2 rounded-full mb-6">
              ...
              <div className="flex items-center justify-between border-t border-gray-100 pt-3 mt-2">
                <div className="flex flex-wrap gap-2">
                  {["I earn RM5k/month", "Auction below RM250k", "Rent-to-own near MRT"].map((chip) => (
                    <span key={chip} className="text-xs bg-emerald-50 text-emerald-700 px-2.5 py-1 rounded-full border border-emerald-100 font-medium">
                      {chip}
                    </span>
                  ))}
                </div>
                <button
                  type="submit"
                  className="flex items-center gap-2 bg-gradient-to-r from-emerald-600 via-teal-600 to-teal-700 text-white font-semibold px-5 py-2 rounded-xl text-sm shrink-0"
                >
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/ai-search" className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-6 py-3 rounded-xl transition-colors text-sm">
              Start AI Search
            </Link>
            ...
            <Link href="/rent-to-own" className="bg-teal-600 hover:bg-teal-700 text-white font-semibold px-6 py-3 rounded-xl transition-colors text-sm">
              Explore Rent-to-Own
            </Link>
          </div>
        </div>
      ...
      <section className="bg-white py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <p className="text-emerald-700 font-semibold text-sm uppercase tracking-wider mb-2">Simple Process</p>
      ...
      <section className="bg-slate-50 py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <p className="text-emerald-700 font-semibold text-sm uppercase tracking-wider mb-2">Explore</p>
            ...
            {[
              ...
              <div key={cat.title} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 group">
                ...
                <div className="p-6">
                  ...
                  <p className="text-emerald-700 text-xs font-semibold mb-4 uppercase tracking-wide">{cat.count}</p>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between mb-8">
          <div>
            <p className="text-emerald-700 font-semibold text-sm uppercase tracking-wider mb-1">Subsale Properties</p>
            <h2 className="text-2xl font-bold text-gray-900">Featured Listings</h2>
          </div>
          <Link href="/subsale" className="text-emerald-700 hover:text-emerald-800 font-semibold text-sm flex items-center gap-1">
            View All
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between mb-8">
            <div>
              <p className="text-emerald-700 font-semibold text-sm uppercase tracking-wider mb-1">For Rent</p>
              <h2 className="text-2xl font-bold text-gray-900">Latest Rental Listings</h2>
            </div>
            <Link href="/rent" className="text-emerald-700 hover:text-emerald-800 font-semibold text-sm flex items-center gap-1">
              View All
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
      ...
      <section className="bg-slate-900 py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <p className="text-emerald-400 font-semibold text-sm uppercase tracking-wider mb-2">Technology</p>
      ...
      <section className="bg-white py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <p className="text-emerald-700 font-semibold text-sm uppercase tracking-wider mb-2">Benefits</p>
      ...
      {/* CTA BANNER */}
      <section className="bg-gradient-to-r from-emerald-600 via-teal-600 to-teal-700 py-16 px-4 text-center">
        ...
        <Link
          href="/ai-search"
          className="inline-flex items-center gap-2 bg-white text-emerald-700 hover:bg-emerald-50 font-bold px-8 py-3.5 rounded-xl text-sm transition-colors shadow-xl"
        >
