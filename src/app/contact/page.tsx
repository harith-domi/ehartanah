    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-gradient-to-r from-emerald-700 to-teal-700 py-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-emerald-200 text-sm">We&apos;d love to hear from you. Our team responds within 24 hours on business days.</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-5">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-800">+60 3-1234 5678</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <div className="w-8 h-8 bg-emerald-50 rounded-lg flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-800">Level 28, Menara Kuala Lumpur</p>
                    <p className="text-xs text-gray-500">50480 Kuala Lumpur, Malaysia</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-600 to-teal-700 rounded-2xl p-5 text-white text-center">
              ...
              <p className="text-emerald-100 text-xs mb-3">Get instant answers about properties, yields, and auction deals.</p>
