    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-gradient-to-r from-blue-700 to-violet-700 py-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-blue-200 text-sm">We&apos;d love to hear from you. Our team responds within 24 hours on business days.</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-violet-700 rounded-2xl p-5 text-white text-center">
              ...
              <p className="text-blue-100 text-xs mb-3">Get instant answers about properties, yields, and auction deals.</p>
