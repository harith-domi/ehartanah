...
import type { AuctionListing } from '@/lib/listings';

export default function AdminTable({ listings }: { listings: AuctionListing[] }) {
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap gap-3 mb-4">
        ...
        {(q || type || region) && (
          <button
            onClick={() => { setQ(''); setType(''); setRegion(''); }}
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50 border-b border-gray-100">
            <tr>
              ...
              <th className="text-left px-4 py-3 font-semibold text-gray-600 whitespace-nowrap">Reserve Price</th>
            </tr>
          </thead>
